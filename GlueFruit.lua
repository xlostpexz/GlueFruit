...
local DinoWindow = Dino:CreateWindow("Glue Fruit")
local DinoPage = DinoWindow:NewPage("Main")
local Home = DinoPage:NewSection("----- Auto Farm Dark Fruit Only -----")
    
    Home:CreateToggle("Auto Noob Knife",function(value)
       _G.NoClip = value
       _G.NKF = value
       _G.Dark = value
    end)
    ...
    spawn(function()
       ...
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.NKF then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").NPC["Noob Knife"].HumanoidRootPart.CFrame * CFrame.new(0,8,0)
            end
        end)
       end)
        end)
       ...
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.BD then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").NPC["Bandit [Lv.1]"].HumanoidRootPart.CFrame * CFrame.new(0,8,0)
            end
        end)
       end)
        end)
...
spawn(function()
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.TSN then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").NPC["The Senator[Noob]"].HumanoidRootPart.CFrame * CFrame.new(0,8,0)
            end
        end)
       end)
        end)
...
spawn(function()
       game:GetService("RunService").RenderStepped:Connect(function()
        pcall(function()
            if _G.MOK then
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").NPC["Money[Lv.200]"].HumanoidRootPart.CFrame * CFrame.new(0,8,0)
            end
        end)
       end)
        end)
